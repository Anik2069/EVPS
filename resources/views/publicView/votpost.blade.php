                                ...
                                <div class="post-meta">
                                    ...
                                    <div class="d-flex align-items-center">
                                        @if($date==$val['votingdate'])
                                            ...
                                            <a href="/viewdetails1/{{$val['id']}}" class="post-comment align-items-left">
                                                <button class="btn btn-danger">View More</button>
                                            </a>
                                        @elseif($date<=$val['votingdate'])
                                            <a href="#" class="post-like" ><button class="btn btn-danger" disabled>Vote will be stared at {{$val['votingdate']}}</button></a>
