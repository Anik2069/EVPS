            ...
            <div class="row">
                <div class="col-12">
                    <div class="top-header-content d-flex align-items-center justify-content-between">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.blade.php"><img src="../{{'assets/'}}img/core-img/logo2.png" alt=""></a>
                        </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="blog-posts-area">
                    ...
                    <div class="single-blog-post featured-post single-post">
                        <div class="post-thumb">
                            <a href="#"><img src="../uploads/{{$value['image']}}" alt=""></a>
                        </div>
                        <div class="post-data">
                            <a href="#" class="post-catagory">Voting Registration</a>
                            <a href="#" class="post-title">
                                <h6>{{$value['title']}}</h6>
                            </a>
                            <div class="post-meta">
                                <p class="post-author">By <a href="#">{{$value['creator']}}</a></p>
                                <h5>Description:</h5>
                                <p> {{$value['content']}}</p>
                                <p><strong>Postion:</strong> {{$value['position']}}</p>
                                <p><Strong> Deadline: </Strong> {{$value['deadline']}}</p>
                                <p><Strong> Voting Date: </Strong>{{$value['votingdate']}}</p>
                                <p><Strong> Starting Time: </Strong> {{$value['t1']}} &nbsp;&nbsp;&nbsp; <Strong> Ending
                                        Time: </Strong> {{$value['t2']}} </p>
                                ...
                                <div class="newspaper-post-like d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center post-like--comments">
                                        <div class="row container-fluid">
                                            ...
                                            @if($value['votingdate'] == $date)
                                                @foreach($value1 as $val1)
                                                    @foreach($value2 as $val2)
                                                        @if($val1['can']==$val2['email'])
                                                            <div class="col-md-6">
                                                                <h5>Candidate:</h5>
                                                                <img src="../uploads/{{$val2['image']}}" height="400" width="300">
                                                                <p>Name: {{$val2['name']}}</p>
                                                                <p><strong>Do You want to vote him??</strong></p>
                                                                <a href="/voteorg/{{$val1['id']}}" class="post-like">
                                            ...
                                            @else
                                                <h5 style="color:Red">Registration Is over</h5>
