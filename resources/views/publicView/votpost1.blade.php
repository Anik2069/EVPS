                    ...
                    @foreach($value as $val)
                        <div class="single-blog-post featured-post mb-30">
                            ...
                            <div class="post-data">
                                ...
                                <div class="post-meta">
                                    <p class="post-author">By <a href="#">Govt. Organization</a></p>
                                    <p class="post-excerp">{{$val['content1']}} </p>
                                    <!-- Post Like & Post Comment -->
                                    <div class="d-flex align-items-center">
                                        @if($date==$val['votingdate'])
                                            <a href="#" class="post-like">
                                                <button class="btn btn-danger">Vote Now</button>
                                            </a>
                                            <a href="/viewdetails1/{{$val['id']}}"
                                               class="post-comment align-items-left">
                                                <button class="btn btn-danger">View More</button>
                                            </a>
                                        @elseif($date<=$val['votingdate'])
                                            <a href="#" class="post-like">
                                                <button class="btn btn-danger" disabled>Vote will be stared
                                                    at {{$val['votingdate']}}</button>
                                            </a>

                                        @else
                                            <a href="#" class="post-like">
                                                <button class="btn btn-danger" disabled>Vote is Over</button>
                                            </a>
                                        @endif
