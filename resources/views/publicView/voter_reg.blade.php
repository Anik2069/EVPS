                                            ...
                                            <div class="single-blog-post small-featured-post d-flex">
                                                ...
                                                <div class="post-data">
                                                    ...
                                                    <div class="post-meta">
                                                        ...
                                                        <p class="post-date"><span>7:00 AM</span> |
                                                            <span>April 14</span></p>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="contact-form-area">
                    <form action="/submitorgvot" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-12">
                                <input type="submit" class="btn btn-danger" value="Press for Vote">
                            </div>
                        </div>
                    </form>
                </div>
