...
<!-- createpost.blade.php  21 Nov 2019 04:05:02 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Write Your Voting Post.....</h4>
                                </div>
                                <form method="post" action="/elcpost" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">election type</label>
                                            <div class="col-sm-12 col-md-7">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Deadline
                                                Date</label>
                                            <div class="col-sm-12 col-md-7">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Voting
                                                Date</label>
                                            <div class="col-sm-12 col-md-7">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-2">
                                                <input type="time" name="vtime" class="form-control">
                                            </div>
...
<!-- createpost.blade.php  21 Nov 2019 04:05:03 GMT -->
</html>
