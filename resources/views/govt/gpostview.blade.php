...
<head>
    ...
    <link rel="stylesheet" href="{{'assets/'}}assets/bundles/bootstrap-daterangepicker/daterangepicker.css">
    <link rel="stylesheet"
          href="{{'assets/'}}assets/bundles/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
    <link rel="stylesheet" href="{{'assets/'}}assets/bundles/select2/dist/css/select2.min.css">
    <link rel="stylesheet" href="{{'assets/'}}assets/bundles/jquery-selectric/selectric.css">
    <link rel="stylesheet" href="{{'assets/'}}assets/bundles/bootstrap-timepicker/css/bootstrap-timepicker.min.css">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu dropdown-menu-right pullDown">
                        ...
                        <a href="login.blade.php" class="dropdown-item has-icon text-danger"> <i
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>GOVERNMENT POST information</h4>
                                </div>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach($value as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="uploads/{{$value['image']}}" alt="image" width="100px" >
...
<!-- JS Libraies -->
<script src="{{'assets/'}}assets/bundles/cleave-js/dist/cleave.min.js"></script>
<script src="{{'assets/'}}assets/bundles/cleave-js/dist/addons/cleave-phone.us.js"></script>
<script src="{{'assets/'}}assets/bundles/jquery-pwstrength/jquery.pwstrength.min.js"></script>
<script src="{{'assets/'}}assets/bundles/bootstrap-daterangepicker/daterangepicker.js"></script>
