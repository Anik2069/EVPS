                    ...
                    <ul class="nav nav-tabs" id="myTab2" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="home-tab2" data-toggle="tab" href="#about" role="tab"
                          aria-selected="true">About Full Post</a>
                      </li>
                  {{--    <li class="nav-item">
                      ...
                      <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                        <div class="row">
                          <div class="col-md-12 col-6 b-r">
                              ...
                              <img src="/uploads/{{$value['image']}}" height="400" width="600">
                              <br>
                              <br>


                            <p class="text-muted"> <strong>Title:</strong> {{$value['title']}}</p>
                          </div>
                          <div class="col-md-3 col-6 b-r">
                            <strong>Deadline</strong>
                            <br>
                            <p class="text-muted">{{$value['deadline']}}</p>
                          </div>
                          <div class="col-md-3 col-6 b-r">
                            <strong>Voting Date</strong>
                            <br>
                            <p class="text-muted">{{$value['votingdate']}}</p>
                          </div>
                          <div class="col-md-3 col-6">
                            <strong>Postion</strong>
                            <br>
                            <p class="text-muted">{{$value['position']}}</p>
                          </div>
                        </div>
