<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.blade.php"> <img alt="image" src="{{'assets/'}}assets/img/logo.png" class="header-logo" /> <span
        ...
        {{--    <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="postview.blade.php">Blog</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="registration.blade.php">Validation</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="canview.blade.php">Export Table</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="verify.blade.php">Reset Password</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="errors-404.blade.php">404</a></li>
            ...
            <li class="dropdown active">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="anchor"></i><span>Other
                  Pages</span></a>
                <ul class="dropdown-menu">
                    <li class="active"><a class="nav-link" href="createpost.blade.php">Create Post</a></li>
