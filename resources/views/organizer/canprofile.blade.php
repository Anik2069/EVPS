                            ...
                            <div class="card author-box">
                                <div class="card-body">
                                    <div class="author-box-center">
                                        <img alt="image" src="../{{'assets/'}}assets/img/users/user-1.png"
                                             class="rounded-circle author-box-picture">
                                        <div class="clearfix"></div>
                                        <div class="author-box-name">
                                            <a href="#">{{$name}}</a>
                                        </div>
                                        <div class="author-box-job">{{$cposition}}</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="author-box-description">
                                            <p>
                                                I am very much willing to work to perform that job.
                                            </p>
                                        </div>
                                ...
                                <div class="padding-20">
                                    ...
                                    <div class="tab-content tab-bordered" id="myTab3Content">
                                        <div class="tab-pane fade show active" id="about" role="tabpanel"
                                            ...
                                            <div class="section-title">Personal Assessment</div>
                                            <p>We are following OCEAN model. Accordig to that model we have 5
                                                criteria</p>
                                            <p>We are showing the result of assessment of this person. hopefully we can
                                                cover it up</p>
                                            <ul>
                                                <li><strong>Openencess: </strong> {{$p1}} %</li>
                                                <li><strong>Conscientiousness:</strong> {{$p2}} %</li>
                                                <li><strong>Extraversion:</strong> {{$p3}} %</li>
                                                <li><strong>Agreeableness:</strong> {{$p4}} %</li>

                                                <li><strong>Natural Reactions:</strong> {{$p5}} %</li>

                                            </ul>

                                        </div>

                                        <p>Are you approved His profile as Candidate ??</p>
                                        @if($val['approved']=='0')
