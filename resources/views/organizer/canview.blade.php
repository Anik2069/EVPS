...
<!-- canview.blade.php  21 Nov 2019 03:55:25 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{"assets/"}}assets/bundles/datatables/datatables.min.css">
    <link rel="stylesheet"
          href="{{"assets/"}}assets/bundles/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
...
<script src="{{"assets/"}}assets/bundles/datatables/export-tables/dataTables.buttons.min.js"></script>
<script src="{{"assets/"}}assets/bundles/datatables/export-tables/buttons.flash.min.js"></script>
<script src="{{"assets/"}}assets/bundles/datatables/export-tables/jszip.min.js"></script>
<script src="{{"assets/"}}assets/bundles/datatables/export-tables/pdfmake.min.js"></script>
<script src="{{"assets/"}}assets/bundles/datatables/export-tables/vfs_fonts.js"></script>
<script src="{{"assets/"}}assets/bundles/datatables/export-tables/buttons.print.min.js"></script>
...
<!-- canview.blade.php  21 Nov 2019 03:56:01 GMT -->
</html>
